---
title: Setting up BytebeamArduino for GSM Connectivity
slug: rUVl-setting-up-bytebeamarduino-for-gsm-connectivity
description: Guide will show you how to setup your project for GSM connectivity.
createdAt: Thu Mar 09 2023 07:25:23 GMT+0000 (Coordinated Universal Time)
...
![](/assets/D1BQUjCkMIFtD86qYo7Pu_img3.png)

## **Step 2. Getting the GSM Client Dependencies**

In order to work with GSM Client, you need to install the following libraries,

- [TinyGSM](https://github.com/vshymanskyy/TinyGSM)  - Available in Arduino Library Manager
- [ArduinoHttpClient ](https://github.com/arduino-libraries/ArduinoHttpClient) - Available in Arduino Library Manager
- [SSLClient](https://github.com/govorox/SSLClient)  - You need to install it via GitHub
...
![](/assets/o4g5baYlxiJgT83G055jR_pic2.png)
...
Look at the `SetupClient_GSM` example sketch for reference. See File > Examples > BytebeamArduino > ESP32 > SetupClient\_GSM within the Arduino IDE.

![](/assets/xGVrKTkg_RU8A3MnmvP_g_img1.png)
